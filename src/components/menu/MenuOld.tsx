  ...
  return (
    ...
    >
      ...
      <div className="flex flex-1 flex-col justify-between gap-4 sm:gap-6">
        <nav className="flex flex-1 flex-col justify-end gap-3 lg:flex-row lg:items-center lg:justify-end lg:gap-5 lg:py-28 2xl:items-center 2xl:justify-end 2xl:gap-11 2xl:py-36">
